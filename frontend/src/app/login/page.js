                    ...
                    <div className="flex w-2/5 bg-black/20 backdrop-blur-md shadow-xl rounded-xl border border-white/10 justify-center items-center max-md:w-8/9 py-12 max-md:py-8">
                        <div className="w-full flex flex-col items-center">
                            ...
                            <div className="w-full flex justify-center">
                                {isLogin ? (
                                    <form className="w-[70%] flex flex-col gap-5 max-md:w-[90%]" onSubmit={(e) => {
                                        e.preventDefault;
                                        ...
                                        <button type="submit" className="mt-4 bg-blue-500 hover:bg-blue-600 transition rounded-xl py-3 text-lg text-white font-semibold shadow-lg">
                                            Login
                                        </button>
                                    </form>
                                ) : (
